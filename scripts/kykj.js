class GlobalManager {
	constructor() {
		...
		this.kanjiSel = document.getElementById("KanjiSel");
...
G.kanjiSel.appendChild(document.createElement("option"));
